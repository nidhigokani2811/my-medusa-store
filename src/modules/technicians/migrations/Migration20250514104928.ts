...
export class Migration20250514104928 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "technician" ("id" text not null, "name" text not null, "email" text not null, "technician_id" text not null, "grant_id" text not null, "calendar_id" text not null, "tenant_id" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "technician_pkey" primary key ("id"));`);
